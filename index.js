...
*/
console.log(
  degerlendirmeler.find((degerlendirme) => degerlendirme.isim === "Ahmet")
    .geribildirim
);
/*  Görev 4 (ototest yok):  
...
degerlendirmeler.find(
  (degerlendirme) => degerlendirme.isim === "Reyna"
).geribildirim = "Garsonlar ilgisizdi.";
...
function DegerlendirmeEkle(değerlendirmeler, isim, puan, geribildirim) {
...
function SonDegerlendirmeyiAl(dizi) {
  let degerlendirme = dizi[dizi.length - 1];
  let metin =
    degerlendirme.isim +
    " isimli kişi " +
    degerlendirme.puan +
